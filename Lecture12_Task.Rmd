...
This time there is no real stress for you! Simply read provided text below. Try to understand what this code does...
...
?read_csv
DF <- read_csv("DF_Data.csv", col_types = "i?iii")
```
