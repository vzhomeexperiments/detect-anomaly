...
```{r}
# mse_out is a dataframe containing MSE error for each row of the matrix
DF_M4c <- DF_M4
for(i in 1:nrow(mse_out)) {
  # we have objects DF_M4DT and DF_M4
  for(j in 1:150){ DF_M4c[i, j] <- mse_out[i] }
