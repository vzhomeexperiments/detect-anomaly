...
```{r, eval=FALSE, include=TRUE}
predicted <- as.data.frame(test_recon)
write.csv(predicted, "test_predicted.csv")
```
...
our next step will be to repeat the procedure but on our machine data. Once we can have our model ready next step will be implementation in our ShinyApp...
