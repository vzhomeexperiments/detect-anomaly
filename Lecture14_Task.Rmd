...
# in server.R: create snippet module with observeEvent
 observeEvent(input$updateGraph, {
    # code below will be executed only when actionButton is pressed
   DF_SUM <- reactive({
...
This practical excercise will allow you to practice skills to crete action button with inputId = "updateGraph" as well as to execute code in Shiny only after this button was pressed

Try to add new button to the right of the selectInput field and make sure that the Plot-Points is only updated once user pressing the new button