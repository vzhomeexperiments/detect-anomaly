...
### replace 'read_csv("DF_Data.csv")' with appropriate function and data e.g. 'DF_Data_Process_Recent.data'
...
DF_EvCode <- read_csv("DF_EvCodeData.csv") #use file 'DF_EvCodeDataProject.csv'
...
DF_TEMP <- DF_Data %>% 
  ...
  select(StartDateTime, Name, TimeTotal, EventText) # check how columns are named in DF_Data...
# ================================= 
